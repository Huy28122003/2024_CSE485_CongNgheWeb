...
CREATE TABLE Employees(
	...
	email CHAR(30),
	mobilePhone CHAR(10),
	positionn VARCHAR(50),
	avatar CHAR(30),departments
	departmentID INT,
...
insert into Users (username, passwordd, rolee) values ('Jonell Risso', 'aL0#.3tTqe@@*d"MH?<2/''7\Gn"$A', 'in');
insert into Users (username, passwordd, rolee) values ('Hatti Stalman', 'fU4#$,K@,f69d$T|AlFzR}d8%AV}s|', 'in');
insert into Users (username, passwordd, rolee) values ('Eal Bellison', 'cG6&Q__/zeh&)yFlb")+z(MA''sIKQkt', 'curae');
insert into Users (username, passwordd, rolee) values ('Reggi Allabarton', 'tH2=n"q%oB"$Jgr|dZnt>gjSoi~%', 'donec');
insert into Users (username, passwordd, rolee) values ('Lorenzo Georgeot', 'yI1?6+F!fI1KF`*e3', 'pede');
insert into Users (username, passwordd, rolee) values ('Ashbey Scutching', 'pI5<FqlXk$v/7*%nRo\_{', 'euismod');
insert into Users (username, passwordd, rolee) values ('Lacy Buzine', 'vJ2)M4M)R.7!ygTpB?I', 'libero');
insert into Users (username, passwordd, rolee) values ('Brandice Busst', 'tM2<GDSp73vGC045(', 'pede');
insert into Users (username, passwordd, rolee) values ('Correy Depke', 'vE7*0j}QHvIPCA(fycZZh!(Yq>', 'vel');
insert into Users (username, passwordd, rolee) values ('Rogers Craighall', 'eQ1,jz5?6j0vah''.Ci19aw0', 'sapien');
insert into Users (username, passwordd, rolee) values ('Minny Cohani', 'fY8''UUMl_''H6QG_v|%JckWFsB&53}n', 'quam');
insert into Users (username, passwordd, rolee) values ('Cammy Placstone', 'bD2#/GnmGX=)9wBlTt`&', 'rutrum');
insert into Users (username, passwordd, rolee) values ('Cynthea McGarva', 'xC3*Wat(F|gI`HN>a', 'odio');
insert into Users (username, passwordd, rolee) values ('Melisandra Jeenes', 'mR1?Z#l''`=MT!=x''5Nfo?l\N2?j}(0', 'quis');
insert into Users (username, passwordd, rolee) values ('Lyndsay Assender', 'wU0~#g9#*tmsuGqf3v\,tZl', 'cursus');
insert into Users (username, passwordd, rolee) values ('Marianne Piscopello', 'uB9+SM*?=pR+Y!w}@4Zf@&LKmM*%E#', 'magna');
insert into Users (username, passwordd, rolee) values ('Wells Orhtmann', 'tV2/@,P3J,PNNM*q<}}D', 'est');
insert into Users (username, passwordd, rolee) values ('Maxim Hegges', 'dU9<+70eg7JenNJwn{r1FcK>', 'cras');
insert into Users (username, passwordd, rolee) values ('Jenifer Sherwood', 'oS4''pCtdm\gazV@N@hfHt*36T*hJ$IW', 'id');
insert into Users (username, passwordd, rolee) values ('Humphrey McGilvary', 'oB1''H~5ZKeYorw\i!1_zg', 'nec');