...
-- Dumping data for table telephonebook.departments: ~0 rows (approximately)
...
INSERT INTO `employees` (`employeeID`, `fullname`, `address`, `email`, `mobilePhone`, `positionn`, `avatar`, `departmentID`) VALUES
	...
	(20, 'canhh', '4 Shasta Courts', 'wrhodesj@fda.gov', '7754799417', 'ipsum,', '/public/assets/img/logonu.jpg', 10);
